...
# 反発係数があれば重力合計値を計算して返却
    ...
    execute if data storage neac: _.MarkerMotion.bounce.e unless score #MarkerMotion.Bounce.e neac_value matches 1000 run scoreboard players operation #MarkerMotion.GravitySum neac_value /= #global 1000
