...
# 到達点探査
execute if entity @e[type=#marker_motion:selector,tag=MarkerMotion.this,distance=..0.0625,limit=1] run data modify storage neac: _.tp[3][].success set value 1b
