...
# エンティティ探査
execute if entity @e[tag=MarkerMotion.target,limit=1] positioned ~-0.03125 ~-0.03125 ~-0.03125 as @e[tag=MarkerMotion.target,dx=0,dy=0,dz=0] positioned ~-0.9375 ~-0.9375 ~-0.9375 if entity @s[dx=0,dy=0,dz=0] run data modify storage neac: _.tp[4][].success set value 1b

# 到達点探査
execute if entity @e[type=#marker_motion:selector,tag=MarkerMotion.this,distance=..0.03125,limit=1] run data modify storage neac: _.tp[4][].success set value 1b
