...
# エンティティ探査
execute if entity @e[tag=MarkerMotion.target,x=0,limit=1] positioned ~-0.015625 ~-0.015625 ~-0.015625 as @e[tag=MarkerMotion.target,dx=0,dy=0,dz=0] positioned ~-0.96875 ~-0.96875 ~-0.96875 if entity @s[dx=0,dy=0,dz=0] run tag @s add MarkerMotion.hit
...
# ブロック扱いエンティティ探索
execute if data storage neac: _.tp[5][{success:2b}] unless data storage neac: _.MarkerMotion.stopwith{block:0b} if entity @e[type=!marker,tag=MarkerMotion.as_block,x=0,limit=1] positioned ~-0.000030517578125 ~-0.000030517578125 ~-0.000030517578125 as @e[type=!marker,tag=MarkerMotion.as_block,dx=0,dy=0,dz=0] positioned ~-0.999969482421875 ~-0.999969482421875 ~-0.999969482421875 if entity @s[dx=0,dy=0,dz=0] run tag @s add MarkerMotion.hitAsBlock
execute if data storage neac: _.tp[5][{success:2b}] unless data storage neac: _.MarkerMotion.stopwith{block:0b} if entity @e[type=!marker,tag=MarkerMotion.hitAsBlock,x=0,limit=1] run function marker_motion:tp/as_block/
