...
#   function marker_motion:tp/block/pos_repair
    ...
    execute positioned as @s align xyz unless predicate marker_motion:block_check/shape if score #MarkerMotion.PosRepair neac_value matches 1.. positioned as @s run function marker_motion:tp/block/pos_repair
