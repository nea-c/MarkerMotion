...
execute if entity @s[tag=NeAcMarkerMotion.on_block,tag=!NeAcMarkerMotion.on_block.wall] run data modify entity @s data.NeAcMarkerMotion.bounce.count set value 1
execute if entity @s[tag=NeAcMarkerMotion.on_block,tag=!NeAcMarkerMotion.on_block.wall] run function neac_marker_motion:tag_remove
